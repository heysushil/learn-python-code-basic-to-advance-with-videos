# मैंने एक यूट्यूब चैनल सुरू किया हूँ और आप यहाँ से सही तरीके से प्रोग्रामिंग सीख सकते हो साथ ही थोड़ा साहियोग ये भी चाहिए की इसे अपने दोस्तों से भी जरूर सेयर करो ताकि वो भी इस का फायदा ले सके क्यों की ज्ञान बांटने से ही बढ़ता हैं - https://www.youtube.com/channel/UCphs2JfmIClR62wbyf76HDg

# अगर डेवलपमेंट फील्ड मे आना चाहते हो और समझ nahi आ रहा है की कैसे क्या करू को तो मुझे कान्टैक्ट कर सकते हो heykyakaru@gmail.com पर और मैं कोसिस करूंगा सही गाइड करने की। क्योंकी बिना गुइडेंसए के कई बार हु काफी परेसान हो जाते हैं की क्या करे और कैसे करे। 
